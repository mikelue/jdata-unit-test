...
:ThreadLocal: link:https://docs.oracle.com/javase/8/docs/api/java/lang/ThreadLocal.html[ThreadLocal]
...
:postgresql: link:https://www.postgresql.org/[PostgreSql]
:mysql: link:https://www.mysql.com/[MySql]
:oracle: link:https://www.oracle.com/database/index.html[Oracle]
:mssql: link:https://www.microsoft.com/en-cy/sql-server/sql-server-downloads[MsSql]
:h2: link:https://www.h2database.com/[H2]
:hsqldb: link:https://hsqldb.org/[HsqlDb]
:derby: link:https://db.apache.org/derby/[Derby]
:DataGrainOperator: link:apidocs/guru/mikelue/jdut/operation/DataGrainOperator.html[DataGrainOperator]
:Consumer: link:https://docs.oracle.com/javase/8/docs/api/java/util/function/Consumer.html[Consumer]
:DataSource: link:https://docs.oracle.com/javase/8/docs/api/javax/sql/DataSource.html[DataSource]
:Connection: link:https://docs.oracle.com/javase/8/docs/api/java/sql/Connection.html[Connection]
:Reader: link:https://docs.oracle.com/javase/8/docs/api/java/io/Reader.html[Reader]
:Map: link:https://docs.oracle.com/javase/8/docs/api/java/util/Map.html[Map]
:JUnit4: link:https://junit.org/junit4/[JUnit4]
...
link:https://docs.oracle.com/javase/8/docs/api/java/util/function/Supplier.html[Supplier<?>]:: The value of field could be a supplier, which working as lazy-evaluation
...
to decide which method of `setXXX` in link:https://docs.oracle.com/javase/8/docs/api/java/sql/PreparedStatement.html[PreparedStatement]
to be called for setting parameter of SQL.

link:https://docs.oracle.com/javase/8/docs/api/java/util/Date.html[java.util.Date]:: the engine would use link:https://docs.oracle.com/javase/8/docs/api/java/sql/PreparedStatement.html#setTimestamp-int-java.sql.Timestamp-[PreparedStatement.setTimestamp()].

**Type cannot be decided**:: the engine would use link:https://docs.oracle.com/javase/8/docs/api/java/sql/PreparedStatement.html#setObject-int-java.lang.Object-[PreparedStatement.setObject()]
...
`NUMERIC` and `DECIMAL`:: the value would be converted into link:https://docs.oracle.com/javase/8/docs/api/java/math/BigDecimal.html[BigDecimal].

==== Complex Value
For type of complex value, you could use link:https://docs.oracle.com/javase/8/docs/api/java/util/function/Supplier.html[Supplier<?>] to create data of these types:
**ARRAY**, **DISTINCT**, **JAVA_OBJECT**, **OTHER**, **REF**, **REF_CURSOR**, **ROWID**, **STRUCT**

==== References
* link:https://bitbucket.org/asomov/snakeyaml/wiki/Documentation#markdown-header-yaml-tags-and-java-types[Data types provided by SnakeYaml]
* link:https://bitbucket.org/asomov/snakeyaml/wiki/Documentation[SnakeYaml Documentation]
...
{DuetConductor}:: This interface defines build/clean data for link:https://en.wikipedia.org/wiki/Unit_testing[unit test].
...
==== Execute build/clean
The {DuetConductor} should be used in proper event defined by link:https://en.wikipedia.org/wiki/List_of_unit_testing_frameworks#Java[testing framework].

For {JUnit4}::
	* link:apidocs/guru/mikelue/jdut/DuetConductor.html#build--[build()] - Could be used in link:https://junit.org/junit4/javadoc/latest/org/junit/Before.html[@Before] annotated method.
	* link:apidocs/guru/mikelue/jdut/DuetConductor.html#clean--[clean()] - Could be used in link:https://junit.org/junit4/javadoc/latest/org/junit/After.html[@After] annotated method.

For {TestNG}::
	* link:apidocs/guru/mikelue/jdut/DuetConductor.html#build--[build()] - Could be used in link:https://jitpack.io/com/github/cbeust/testng/master/javadoc/org/testng/annotations/BeforeMethod.html[@BeforeMethod] annotated method.
	* link:apidocs/guru/mikelue/jdut/DuetConductor.html#clean--[clean()] - Could be used in link:https://jitpack.io/com/github/cbeust/testng/master/javadoc/org/testng/annotations/AfterMethod.html[@AfterMethod] annotated method.
...
* **DataFieldPredicates::nonSupplier** - A predicate to check if the data of field doesn't comes from link:https://docs.oracle.com/javase/8/docs/api/java/util/function/Supplier.html[Supplier]
...
See link:https://docs.oracle.com/javase/8/docs/api/java/util/function/Predicate.html[Predicate.and(), .or()]
...
See link:https://docs.oracle.com/javase/8/docs/api/java/sql/DatabaseMetaData.html[DatabaseMetaData].
...
. *unique index* with least number of columns and all of their value have non-null value
	* Choose first constraint(as order of link:https://docs.oracle.com/javase/8/docs/api/java/sql/DatabaseMetaData.html#getIndexInfo-java.lang.String-java.lang.String-java.lang.String-boolean-boolean-[DatabaseMetaData.getIndexInfo(...)])
